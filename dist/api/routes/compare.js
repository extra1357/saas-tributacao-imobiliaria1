...
exports.compareRouter = (0, express_1.Router)();
exports.compareRouter.post("/", (0, validate_1.validate)(schemas_1.CompareSchema), async (req, res) => {
    const result = (0, engine_1.comparePFvsPJ)(req.body);
