...
exports.breakevenRouter = void 0;
...
exports.breakevenRouter = (0, express_1.Router)();
exports.breakevenRouter.post("/", (0, validate_1.validate)(schemas_1.BreakevenSchema), async (req, res) => {
    const result = (0, engine_1.calculateBreakeven)(req.body);
